...
# 版本号基于 1.10.8（每次编译 PATCH+1：1.10.8 → 1.10.9 → 1.10.10 ...）
# 注意: 1.10.2 的 gradle.properties 无 BOM，必须用 UTF8(无 BOM) 保编码。
...
[IO.File]::WriteAllText($propsPath, $newContent, $utf8NoBom)
