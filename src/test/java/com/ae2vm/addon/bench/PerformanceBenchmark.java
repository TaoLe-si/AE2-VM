...
public class PerformanceBenchmark {
    ...
    void warmBillionSeededRing() {
        ...
        org.junit.jupiter.api.Assertions.assertEquals(2_000_000_000L, cold.usedItems().get(a), "种子 A 消耗恰为 2e9");
    ...
    private static String contentSig(ICraftingPlan plan) {
        ...
        for (var e : plan.patternTimes().entrySet()) {
            var out = e.getKey().getOutputs() != null && e.getKey().getOutputs().size() > 0
