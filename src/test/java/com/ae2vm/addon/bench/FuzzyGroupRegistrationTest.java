...
public class FuzzyGroupRegistrationTest {
    ...
    private static final class VariantInput implements IInput, BenchInputAccess {
    ...
    private static final class VarPattern implements IPatternDetails, BenchPatternAccess {
    ...
    private static final class TwoLevelPattern implements IPatternDetails, BenchPatternAccess {
        private final IInput[] inputs;
        private final GenericStack output;
