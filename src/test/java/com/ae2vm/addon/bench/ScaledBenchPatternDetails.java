...
public final class ScaledBenchPatternDetails implements IPatternDetails {
    ...
    private final java.util.List<GenericStack> outputs;
    ...
    public ScaledBenchPatternDetails(IPatternDetails original, long operationsPerPush) {
        ...
        List<GenericStack> scaledOutputs = new ArrayList<>(origOutputs.size());
    ...
    @Override
    public java.util.List<GenericStack> getOutputs() { return outputs; }
