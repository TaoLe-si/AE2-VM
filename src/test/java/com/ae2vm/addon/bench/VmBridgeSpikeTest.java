...
public class VmBridgeSpikeTest {
    ...
    public void spikeDispersedDag() {
        ...
        System.out.println("[SPIKE] plan output=" + String.valueOf(plan.finalOutput()) + " x "
                + plan.finalOutput().getStackSize()
                + " sim=" + plan.simulation()
                + " used=" + plan.usedItems()
        ...
        org.junit.jupiter.api.Assertions.assertEquals(4L, BenchCompat.usedOf(plan, D));
        org.junit.jupiter.api.Assertions.assertEquals(4L, BenchCompat.usedOf(plan, E));
        org.junit.jupiter.api.Assertions.assertEquals(4L, BenchCompat.usedOf(plan, F));
        org.junit.jupiter.api.Assertions.assertEquals(4L, BenchCompat.usedOf(plan, G));
    }
}
