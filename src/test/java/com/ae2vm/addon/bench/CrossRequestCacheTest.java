...
public class CrossRequestCacheTest {
    ...
    private static void assertPlansEqual(ICraftingPlan a, ICraftingPlan b, String msg) {
        ...
        Assertions.assertEquals(keyCounter(BenchCompat.used(a)), keyCounter(BenchCompat.used(b)), msg + " (used)");
        ...
        Assertions.assertEquals(keyCounter(BenchCompat.emitted(a)), keyCounter(BenchCompat.emitted(b)), msg + " (emitted)");
        Assertions.assertEquals(patternTimes(a), patternTimes(b), msg + " (patternTimes)");
        Assertions.assertEquals(keyCounter(BenchCompat.missing(a)), keyCounter(BenchCompat.missing(b)), msg + " (missing)");
    }

    private static Map<String, Long> keyCounter(Map<String, Long> m) {
    ...
    void multiStepStockDrain() throws Exception {
        ...
        Assertions.assertEquals(4L, BenchCompat.usedOf(p1, BenchAEKey.of("B")), "s1 used B 4");
        ...
        Assertions.assertEquals(2L, BenchCompat.usedOf(p2, BenchAEKey.of("B")), "s2 used B 2");
        ...
        Assertions.assertEquals(0L, BenchCompat.usedOf(p3, BenchAEKey.of("B")), "s3 used B 0");
    ...
    void amountChangeAcrossReuse() throws Exception {
        ...
        Assertions.assertEquals(4L, BenchCompat.usedOf(p8, BenchAEKey.of("B")), "8 A: used 4 B from stock");
    ...
    void separateVmsDoNotPolluteEachOther() throws Exception {
        ...
        Assertions.assertEquals(2L, BenchCompat.usedOf(v1p1, BenchAEKey.of("B")), "VM1 used B 2");
        Assertions.assertEquals(2L, v1p1.patternTimes().getOrDefault(fx1.byOutput.get(BenchAEKey.of("B")), 0L), "VM1 craft B 2");
        Assertions.assertEquals(4L, BenchCompat.usedOf(v2p1, BenchAEKey.of("B")), "VM2 used B 4");
    ...
    void emptyStockReuseIsDeterministic() throws Exception {
        ...
        Assertions.assertEquals(4L, BenchCompat.missingOf(plan1, BenchAEKey.of("D")), "D missing 4");
