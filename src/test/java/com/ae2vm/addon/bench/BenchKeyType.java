...
/**
 * {@link AEKeyType} for {@link AEKey}. {@code getAmountPerByte()} inherits the
...
final class BenchKeyType extends AEKeyType {
    BenchKeyType() {
        super(
                ...
                com.ae2vm.shim.api.stacks.AEItemKey.class,
                new net.minecraft.util.text.TextComponentString("bench"));
    }
}
