...
public interface IStorageService {
    ...
    void registerAdditionalCellProvider(appeng.api.storage.cells.ICellProvider provider);

    /** v9 surface: unregister an extra cell provider (no-op on v8). */
    void unregisterAdditionalCellProvider(appeng.api.storage.cells.ICellProvider provider);
}
